...
# calculate lenght for every word
#   words are appended by spaces or end of string
# each element of array contains the string followed by a space and the length

# Data structure / algorithm
# split string
# call map on string
#   block return element + ' ' + size of element
